...
export enum ASSET_KEY {
  ...
  APPLE_OBJECT = 'APPLE_OBJECT',
  BANANA_OBJECT = 'BANANA_OBJECT',
  BASKET_OBJECT = 'BASKET_OBJECT',
  MELON_OBJECT = 'MELON_OBJECT',
  TROPHY_OBJECT = 'TROPHY_OBJECT',
  SOUND_ON = 'SOUND_ON',
  SOUND_OFF = 'SOUND_OFF',
  WHITE_PANEL = 'WHITE_PANEL',
  COIN_OBJECT = 'COIN_OBJECT',

  // snake object
  SNAKE_OBJECT = 'SNAKE_OBJECT',
  SNAKE_ROUND_OBJECT = 'SNAKE_ROUND_OBJECT',
